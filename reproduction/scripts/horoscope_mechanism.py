...
Paper:  "Do We Measure What We Claim? Evaluating Statistical Rigor
         in Quantum Error Mitigation Benchmarks" (QCE 2025)
Section: 4.7 (The Horoscope Effect)
...
class ExperimentConfig:
    ...
    def __post_init__(self):
        self.p_2q_values = np.geomspace(5e-5, 5e-2, 5)
...
def run_grover_horoscope(backend) -> list[dict]:
    ...
    for ip, p_2q in enumerate(CFG.p_2q_values):
        ...
        print(f"  [{ip+1:2d}/{len(CFG.p_2q_values)}] p_2q={p_2q:.5f} | noisy={E_noisy:.4f} | "
